...
# THIS BUILDS THE EXAMPLE FOR ARM
arm-none-eabi-gcc -O2 -Wall -Wextra -ffreestanding -mcpu=cortex-m7 -mthumb -mabi=aapcs -std=c99 -I ${ROOT}/include -I ${ROOT}/generated -o out.obj -c ../src/monster.c
arm-none-eabi-objdump -d out.obj > out.lst